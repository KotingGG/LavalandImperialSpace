...
public sealed class GoliathTentacleSystem : EntitySystem
{
    ...
    public override void Initialize()
    {
        ...
        SubscribeLocalEvent<GoliathSummonTentacleActionLavaland>(OnSummonActionLavaland);
    }
    ...
    private void OnSummonActionLavaland(GoliathSummonTentacleActionLavaland args)
    {
        if (args.Handled || args.Coords is not { } coords)
            return;
